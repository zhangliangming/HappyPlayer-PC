...
import com.happy.widget.panel.madelrc.MakeLrcFinishPanel;
import com.happy.widget.panel.madelrc.MakeLrcLvRuPanel;
import com.happy.widget.panel.madelrc.MakeLrcZhiZuoPanel;
 ...
 * 
 */
public class MadeLrcDialog extends JDialog {
				...
				try {
					...
					if (lyricsInfo != null) {
						...
						boolean saveResult = lyricsFileWriter.writer(
								lyricsInfo, hrcsFile.getPath());
						if (saveResult) {
							JOptionPane
									.showMessageDialog(MadeLrcDialog.this,
											"歌词文件保存成功", "提示",
							...
							messageIntent
									.setAction(MessageIntent.CLOSE_MADELRCDIALOG);
					...
					e1.printStackTrace();
					JOptionPane.showMessageDialog(MadeLrcDialog.this,
